/*
Date: 19/11/2023
Screen: Library of Quizzes
Purpose: Allows users to select a quiz to play
*/
...
const LibraryofResourcesQuizzes = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/*The following pressables are components that will link to quizzes*/}
      ...
      <View style={styles.section1TitleCont}>
          ...
          {/*Horizontal scroll quiz components*/}
          <ScrollView
            horizontal
            showsHorizontalScrollIndicator={false}
            style={[styles.scrollContainer, { zIndex: 3 }]}
