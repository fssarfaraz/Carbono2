      ...
      <Pressable 
        ...
        <View style={styles.rowContainer}>
          <View style={styles.leftColumn}>
            <Image style={styles.image} resizeMode="cover" source={require("../assets/search_image3.png")} />
          </View>
          <View style={styles.rightColumn}>
            <Text style={styles.title}>REDUCING YOUR FOOTPRINT</Text>
            <Text style={styles.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, diam in aliquam ullamcorper, nisl nisi aliquet nunc, vitae aliquam nisl nunc quis nunc. </Text>
          </View>
        </View>
        </Pressable>
        ...
        <View style={styles.rowContainer}>
          <View style={styles.leftColumn}>
            <Image style={styles.image} resizeMode="cover" source={require("../assets/search_image1.png")} />
          </View>
          <View style={styles.rightColumn}>
            <Text style={styles.title}>REDUCING YOUR FOOTPRINT</Text>
            <Text style={styles.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, diam in aliquam ullamcorper, nisl nisi aliquet nunc, vitae aliquam nisl nunc quis nunc. </Text>
        ...
        <View style={styles.rowContainer}>
          <View style={styles.leftColumn}>
            <Image style={styles.image} resizeMode="cover" source={require("../assets/search_image2.png")} />
          </View>
          <View style={styles.rightColumn}>
            <Text style={styles.title}>REDUCING YOUR FOOTPRINT</Text>
            <Text style={styles.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, diam in aliquam ullamcorper, nisl nisi aliquet nunc, vitae aliquam nisl nunc quis nunc. </Text>
        ...
        <View style={styles.rowContainer}>
          <View style={styles.leftColumn}>
            <Image style={styles.image} resizeMode="cover" source={require("../assets/search_image4.png")} />
          </View>
          <View style={styles.rightColumn}>
            <Text style={styles.title}>REDUCING YOUR FOOTPRINT</Text>
            <Text style={styles.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, diam in aliquam ullamcorper, nisl nisi aliquet nunc, vitae aliquam nisl nunc quis nunc. </Text>
        ...
        {/* Repeat the above View block for each item in your list */}
      </ScrollView>
