/*
Date: 19/11/2023
Screen: Library of Resources - Transport
Purpose: Displays resources for the category - transport
*/
...
const LibraryofResourcesTranspor = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/*The following pressables are components that link to resources*/}
