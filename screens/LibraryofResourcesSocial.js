/*
Date: 19/11/2023
Screen: Library of Resources - Social
Purpose: Displays resources for the category - Social
*/
...
const LibraryofResourcesSocial = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/*The following pressables are components that when clicked, lead to resources*/}
